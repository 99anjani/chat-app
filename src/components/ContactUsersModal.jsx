...
const ContactUsersModal = ({ isOpen, onClose, startChat}) => {
  ...
  return (
      <div className='fixed inset-0 z-[150] flex justify-center items-center bg-black/60 backdrop-blur-md
        ...
        <div className=' w-full max-w-md max-h-[90vh] flex flex-col overflow-hiddenrounded-2xl border border-white/10 bg-[#13113a] shadow-2xl animate-in fade-in zoom-in-95 duration-200'>
